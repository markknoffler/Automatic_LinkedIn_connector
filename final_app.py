...
# ── Paths & Scripts ───────────────────────────────────────────────────────────
BASE                   = "/Users/samreedhbhuyan/Desktop/MIT_HACKATHON/juris_AI"
PDF_DIR                = f"{BASE}/data"
IMG_DIR                = f"{BASE}/images"
XLS_DIR                = f"{BASE}/excel"
VOICE_DIR              = f"{BASE}/voice"
CHROMA_DIR             = f"{BASE}/chroma"
JSON_PATH              = f"{BASE}/json/summary_main.json"
MSG_DIR                = f"{BASE}/personalised_message"
SUM_SCRIPT             = f"{BASE}/full_summarised_archietecture.py"
OVERVIEW_SCRIPT        = f"{BASE}/overview.py"
FULL_SUMMARY_SCRIPT    = f"{BASE}/full_summarisation.py"
FINAL_CHROMA_SCRIPT    = f"{BASE}/final_chroma_integration.py"
FINAL_LINKEDIN_SCRIPT  = f"{BASE}/final_linkedin_connection.py"
